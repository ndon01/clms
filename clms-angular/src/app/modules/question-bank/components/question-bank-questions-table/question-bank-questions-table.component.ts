...
@Component({
  selector: 'app-question-bank-questions-table',
  standalone: true,
  imports: [
    TableModule,
    Button,
  ...
  templateUrl: './question-bank-questions-table.component.html',
  styleUrl: './question-bank-questions-table.component.css'
})
export class QuestionBankQuestionsTableComponent {
  ...
  @Input() selectionMode: "single" | "multiple" | undefined | null = null;
  @Input() selectedQuestions: QuestionBankQuestionProjection[] | QuestionBankQuestionProjection = [];
  @Output() selectedQuestionsChange = new EventEmitter<QuestionBankQuestionProjection[] | QuestionBankQuestionProjection>();
  @Input() persistSelectionBetweenPages: boolean = false;

  @Input() showEditQuestionCategoriesButton: boolean = false;
  @Input() showEditQuestionButton: boolean = false;
  ...
  onSelectionChange($event) {
    this.selectedQuestionsChange.emit($event);
  }
}
