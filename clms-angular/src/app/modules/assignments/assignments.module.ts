...
@NgModule({
  ...
  exports: [AssignmentOverviewPageComponent, AssignmentEditPageComponent],
    imports: [
        CommonModule, AssignmentsRoutingModule, CoreModule, DatePipe, ButtonDirective, Button, CourseCardComponent, SkeletonModule, OrderListModule, QuestionEditorViewComponent
    ]
})
